                    ...
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            ...
                            <select onChange={e => setSpeciality(e.target.value)} value={speciality} className='border rounded px-2 py-2'>
                                <option value="General physician">Child Psychiatrist</option>
                                <option value="Gynecologist">Behavioral Therapist</option>
                                <option value="Dermatologist">Developmental Psychologist</option>
                                <option value="Pediatricians">Speech Therapist</option>
                                <option value="Neurologist">Autism Specialist</option>
                                <option value="Gastroenterologist">Neuropsychologist</option>
                            </select>
                        </div>
